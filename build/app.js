...
/***/function (module, __webpack_exports__, __webpack_require__) {
	...
	/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__js_playerMap__ = __webpack_require__(2);
	/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__js_theme__ = __webpack_require__(3);
	// Import dependencies
   ...
   */
		var Game = function () {
			function Game(choice) {
				...
				this.playerMap = __WEBPACK_IMPORTED_MODULE_1__js_playerMap__["a" /* playerMap */];

				// Create an array to hold onto remaining enemies
				this.enemies = this.playerMap.map(function (enemy) {
					return enemy.name;
				});
			}
			...
			_createClass(Game, [{
				key: 'startGame',
				value: function startGame(choice) {
					this.playerChoice = choice;
					this.isPlaying = true;
				}
			}, {
				key: 'setDefender',
				value: function setDefender(choice) {
				...
				key: 'eliminateDefender',
				value: function eliminateDefender() {
		...
		var Display = function () {
			...
			_createClass(Display, [{
				...
				value: function initializeDisplay() {
					this.playerMap.map(function (player) {
						__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#players').append('\n          <div class="player" id="' + player.el + '">\n            <h3 class="player-header">' + player.name + '</h3>\n            <div class="image">\n              <!-- <img src="./assets/' + player.img + '" alt="' + player.name + '\'s Avatar" class="player-img" /> -->\n              <img src="http://via.placeholder.com/150x150" alt="Player 1 Avatar" class="player-img" />\n            </div>\n            <div class="player-health">\n              <p>' + player.health + '</p>\n            </div>\n          </div>\n        ');
						__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#main-app').css('display', 'block');
						// ANIMATE SOMETHING HERE
						__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#start').hide();
					});
				}
			}, {
				key: 'showPlayerChoice',
				value: function showPlayerChoice(choice) {
					// Move player's choice to the appropriate div
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#' + choice).detach().appendTo('#player-choice');

					// Move enemies to the appropriate div
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#players').detach().appendTo('#enemies');
				}
			}, {
				key: 'showDefender',
				value: function showDefender(choice) {
					// Move chosen enemy into defender area of DOM
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#' + choice).detach().appendTo('#defender');
				}
			}, {
				key: 'animateAttack',
				...
				value: function updateStatus(status) {
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#status p').text(status);
				}
			}, {
				key: 'resetDisplay',
				value: function resetDisplay() {
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#start').show();
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#players').empty();
				}
			}]);
  ...
  */
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#start').on('click', function startClickHandler() {
			game = new Game();
			display = new Display();
  ...
  */
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#players').on('click', '.player', function playerClickHandler() {
			// Set the user's choice based on the element's id clicked
			var choice = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('id');
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#attack').on('click', function attackClickHandler() {
			if (!game.defender) {
		...
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#reset').on('click', function resetClickHandler() {
			if (game.isPlaying) {
				game.resetGame();
			}
		});
...
/***/function (module, __webpack_exports__, __webpack_require__) {
	...
	var playerMap = [{
		el: 'player-1',
		name: 'Van Gogh',
		image: '../images/player1.img',
		health: 150
	}, {
		el: 'player-2',
		name: 'Damien Hurst',
		image: '../images/player2.img',
		health: 150
	}, {
		el: 'player-3',
		name: 'Jeff Koons',
		image: '../images/player3.img',
		health: 150
	}, {
		el: 'player-4',
		name: 'Leonardo di Vinci',
		image: '../images/player4.img',
		health: 150
	}, {
		el: 'player-5',
		name: 'Hieronymus Bosch',
		image: '../images/player5.img',
		health: 150
	}, {
		el: 'player-6',
		name: 'Helen Frankenthaler',
		image: '../images/player6.img',
		health: 150
	}];
	/* harmony export (immutable) */__webpack_exports__["a"] = playerMap;
